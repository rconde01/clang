...
Environment::CreateVirtualEnvironment(StringRef                Code,
                                      StringRef                FileName,
                                      ArrayRef<tooling::Range> Ranges)
{
   ...
   return llvm::make_unique<Environment>(ID,
                                         std::move(FileMgr),
                                         std::move(VirtualSM),
...
TokenAnalyzer::process()
{
   ...
   FormatTokenLexer      Tokens(
       Env.getSourceManager(), Env.getFileID(), Style, Encoding);
...
void
TokenAnalyzer::consumeUnwrappedLine(const UnwrappedLine & TheLine)
{
