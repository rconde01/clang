...
private:
   ...
   void parseBlock(bool MustBeDeclaration,
                   bool AddLevel  = true,
                   bool MunchSemi = true);
   ...
   // lines. Thus, we need to keep a list of preprocessor directives to be
   // reported after an unwarpped line that has been started was finished.
