...
std::string
computeUsingDeclarationLabel(const FormatToken * UsingTok)
{
...
void
endUsingDeclarationBlock(SmallVectorImpl<UsingDeclaration> * UsingDeclarations,
...
UsingDeclarationsSorter::analyze(
